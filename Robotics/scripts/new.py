...
destination_position4_ = Point()
destination_position4_.x = 3.8
destination_position4_.y = 1
destination_position4_.z = 0

destination_position5_ = Point()
destination_position5_.x = 4
destination_position5_.y = -5
destination_position5_.z = 0
...
# 4 final move
# ------------------
wall_following_direction_ = 'anti-clockwise' # clockwise or anti-clockwise
...
def main():
    ...
    global destination_position1_, destination_position2_, destination_position3_, destination_position4_, destination_position5_
        ...
        if(area_ == 1):
            ...
            while(near_wall_ == False and not rospy.is_shutdown()):
                if(regions_['Front'] > distance_ and regions_['F-Right'] > distance_ and regions_['F-Left'] > distance_):  # Nothing there, go straight
                    ...
                    command.linear.x = 0.22
                elif(wall_following_direction_ == 'anti-clockwise' and regions_['F-Right'] < distance_):
                    near_wall_ = True
                    # print("Right wall found")
                elif(wall_following_direction_ == 'clockwise' and regions_['F-Left'] < distance_):
                    near_wall_ = True
                ...
                pub_cmd_vel_.publish(command)
        if(math.isinf(regions_['F-Left']) and math.isinf(regions_['Left']) and math.isinf(regions_['Front'])):
            if(not area_ == 2 and not area_ == 3 and not area_ == 4 and not area_ == 5):
                area_ = 1
        rate.sleep()
    else:
